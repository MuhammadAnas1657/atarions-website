        ...
        >
          {SERVICES.map(({ Icon, title, desc }, i) => (
            <motion.div
              ...
              className="group relative rounded-3xl border border-white/10 bg-void p-8 shadow-[0_0_0_0_rgba(0,0,0,0)] transition-shadow duration-300 hover:shadow-[0_20px_60px_-12px_rgba(108,79,240,0.45)] hover:border-electric/40 overflow-hidden"
            >
              <motion.div
                animate={
                  reduced
