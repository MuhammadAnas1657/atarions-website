        ...
        >
          {INDUSTRIES.map(({ Icon, title, desc }) => (
            <motion.div
              ...
              className="rounded-3xl border border-white/10 bg-cosmos p-8 transition-shadow duration-300 hover:shadow-[0_20px_55px_-15px_rgba(108,79,240,0.4)] hover:border-electric/30"
            >
